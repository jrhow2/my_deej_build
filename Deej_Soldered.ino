...
const int analogInputs[NUM_SLIDERS] = {A7, A6, A5, A4, A3, A2};
...
const int muteButtons[NUM_MUTES] = {6,13,2,3,4,5};
...
byte colPins[COLS] = {7,12,A0}; //connect to the column pinouts of the keypad
