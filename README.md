...
All of the mechanical design files can be found in the "Mechanical Design" folder. The enclosure was designed in Fusion 360, and I've provided the [.f3d file]('/Mechanical Degin/Jrhow2's Deej.f3d'). 
### Part's list
### 3D-printed Keycaps
